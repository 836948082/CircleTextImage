package com.runtai.library.view;
...
public class CircleTextImage extends ImageView {
    ...
    private int mCircleColor = Color.RED;//默认背景颜色
    private int mCircleTextColor = Color.WHITE;//默认文字颜色
    private Paint mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private boolean useRandomBackgroundColor = false;//是否使用随机背景颜色
    private boolean mSubFirstCharacter = false;//是否截取字符串的第一个字符(如果是英文转换为大写)
